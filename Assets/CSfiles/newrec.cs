...
public class newrec : MonoBehaviour
{
    int[] recTime = new int[100000];
    int frameTime;
    int Rec_onoff;
    int onoff;
    bool record;
    string[] uem = new string[10000];
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (hit.transform.gameObject.tag == "recButton")
                {
                    if (Rec_onoff == 0)
                    {
                        record = true;
                        ...
                        GameObject.Find("rec").GetComponent<Light>().enabled = true;
                        //GameObject.Find("recLight").GetComponent<Renderer>().material.color = new Color(230 / 255f, 0 / 255f, 0 / 255f);
                        Rec_onoff = 1;
                    ...
                    else if (Rec_onoff == 1)
                    {
                        ...
                        GameObject.Find("rec").GetComponent<Light>().enabled = false;
                        //GameObject.Find("recLight").GetComponent<Renderer>().material.color = new Color(0 / 255f, 0 / 255f, 0 / 255f);
                    }
                }
            }
        }
        ...
        if (Input.GetKeyDown(KeyCode.P))
        {
         ...
         if (Input.GetMouseButtonDown(0))
         {
            ...
            if (Physics.Raycast(ray, out hit))
            {
                if (hit.transform.gameObject.tag == "playButton")
                {
                    play = true;
                    playu = 0;
                }
